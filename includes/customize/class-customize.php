				 ...
				 */
					...
					$options = array(
						...
						100 . 'colors' . 20 => array(
							 ...
							 */
								...
								100 . 'colors' . 20 . 300 => array(
									'type'        => 'html',
									'content'     => '<h3>' . esc_html__( 'Header widgets', 'modern' ) . '</h3>',
									'description' => esc_html__( 'Please note that this widgets area is displayed only if it contains some widgets.', 'modern' ),
								),
						...
						100 . 'colors' . 25 => array(
							 ...
							 */
								...
								100 . 'colors' . 25 . 500 => array(
									'type'        => 'html',
									'content'     => '<h3>' . esc_html__( 'Intro widgets', 'modern' ) . '</h3>',
									'description' => esc_html__( 'Please note that this widgets area is displayed only if it contains some widgets.', 'modern' ),
								),
						...
						100 . 'colors' . 40 => array(
							 ...
							 */
								...
								100 . 'colors' . 40 . 200 => array(
									'type'        => 'html',
									'content'     => '<h3>' . esc_html__( 'Secondary widgets', 'modern' ) . '</h3>',
									'description' => esc_html__( 'Please note that this widgets area is displayed only if it contains some widgets.', 'modern' ),
								),
									...
									100 . 'colors' . 40 . 210 => array(
										...
										'preview_js' => array(
											'css' => array(
												...
												'.footer-secondary-widgets-inner, ' . self::color_selectors( 'footer-secondary-widgets' ) => array(
													'background-color'
												),
									...
									100 . 'colors' . 40 . 230 => array(
										...
										'preview_js' => array(
											'css' => array(
												...
												$h_tags . ', @a, @.accent-color' => array(
													'selector_replace' => '.footer-secondary-widgets-inner ',
													'color'
												),
						...
						200 . 'blog' => array(
							'id'             => 'blog',
							'type'           => 'section',
							'create_section' => esc_html_x( 'Blog', 'Customizer section title.', 'modern' ),
							'in_panel'       => esc_html_x( 'Theme Options', 'Customizer panel title.', 'modern' ),
						),
							...
							200 . 'blog' . 100 => array(
								'type'        => 'radio',
								'id'          => 'blog_style',
								'label'       => esc_html__( 'Blog style', 'modern' ),
								'description' => esc_html__( 'This layout style will be applied on blog, category and tag archive pages.', 'modern' ),
								'default'     => 'list',
								'choices'     => array(
									'list'    => esc_html__( 'List', 'modern' ),
									'masonry' => esc_html__( 'Masonry', 'modern' ),
								),
							),
							...
							200 . 'blog' . 110 => array(
								...
								'label'           => esc_html__( 'Masonry image size', 'modern' ),
								'description'     => esc_html__( 'Select a size for post thumbnail image in masonry style blog.', 'modern' ),
								'default'         => 'thumbnail',
						...
						300 . 'layout' => array(
							 ...
							 */
								...
								300 . 'layout' . 100 => array(
									'type'    => 'html',
									'content' => '<h3>' . esc_html_x( 'Site Container', 'A website container.', 'modern' ) . '</h3>',
								),

									300 . 'layout' . 110 => array(
										'type'    => 'radio',
										'id'      => 'layout_site',
										'label'   => esc_html__( 'Website layout', 'modern' ),
										'default' => 'fullwidth',
										'choices' => array(
											'fullwidth' => esc_html__( 'Fullwidth', 'modern' ),
											'boxed'     => esc_html__( 'Boxed', 'modern' ),
										),
									...
									300 . 'layout' . 120 => array(
										...
										'label'       => esc_html__( 'Website max width', 'modern' ),
										'description' => esc_html__( 'For boxed website layout.', 'modern' ) . '<br />' . sprintf( esc_html__( 'Default value: %s', 'modern' ), number_format_i18n( 1640 ) ),
										'default'     => 1640,
										'min'         => 1000,
									...
									300 . 'layout' . 130 => array(
										...
										'label'       => esc_html__( 'Content width', 'modern' ),
										'description' => sprintf( esc_html__( 'Default value: %s', 'modern' ), number_format_i18n( 1180 ) ),
										'default'     => 1180,
										'min'         => 880,
							 ...
							 */
								...
								300 . 'layout' . 200 => array(
									...
									300 . 'layout' . 210 => array(
										'type'    => 'radio',
										'id'      => 'layout_header',
										'label'   => esc_html__( 'Header layout', 'modern' ),
										'default' => 'fullwidth',
										'choices' => array(
											'fullwidth' => esc_html__( 'Fullwidth', 'modern' ),
											'boxed'     => esc_html__( 'Boxed', 'modern' ),
									...
									300 . 'layout' . 220 => array(
										...
										'label'       => esc_html__( 'Sticky header', 'modern' ),
										'description' => esc_html__( 'Allow header to appear when user attempt to scroll up.', 'modern' ),
										'default'     => true,
							 ...
							 */
								...
								300 . 'layout' . 300 => array(
									...
									300 . 'layout' . 310 => array(
										...
										'label'       => esc_html__( 'Enable intro widgets', 'modern' ),
										'description' => sprintf( esc_html_x( 'If you enable this widget area also for archives, we recommend using %s plugin to control its appearance further more.', '%s: Linked plugin name.', 'modern' ), '<a href="https://wordpress.org/plugins/woosidebars/">WooSidebars</a>' ),
										'default'     => '',
										'choices'     => array(
											''       => esc_html__( 'On singular pages only', 'modern' ),
											'always' => esc_html__( 'On both archive and singular pages', 'modern' ),
										),
									),
							 ...
							 */
								...
								300 . 'layout' . 500 => array(
									...
									300 . 'layout' . 510 => array(
										'type'    => 'radio',
										'id'      => 'layout_footer',
										'label'   => esc_html__( 'Footer layout', 'modern' ),
										'default' => 'boxed',
										'choices' => array(
											'fullwidth' => esc_html__( 'Fullwidth', 'modern' ),
											'boxed'     => esc_html__( 'Boxed', 'modern' ),
