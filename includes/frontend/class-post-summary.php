			...
			// Processing
				...
				// Hooks
					...
					// Filters
						...
						add_filter( 'wmhook_modern_summary_continue_reading', __CLASS__ . '::continue_reading' );
			...
			// Requirements check
				...
				if ( post_password_required( $post_id ) ) {
					...
					if ( ! is_single( $post_id ) ) {
						...
						return esc_html__( 'This content is password protected.', 'modern' ) . ' <a href="' . esc_url( get_permalink() ) . '">' . esc_html__( 'Enter the password to view it.', 'modern' ) . '</a>';
