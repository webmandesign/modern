		...
		public static function preview_scripts() {
			...
			// Output
				...
				if ( $output = trim( $output ) ) {
					echo apply_filters( 'wmhook_modern_library_customize_preview_scripts_output', '<!-- Theme custom scripts -->' . "\r\n" . '<script type="text/javascript"><!--' . "\r\n" . '( function( $ ) {' . "\r\n\r\n" . trim( $output ) . "\r\n\r\n" . '} )( jQuery );' . "\r\n" . '//--></script>' );
				}
		...
		public static function customize( $wp_customize ) {
			...
			// Helper variables
				...
				// To make sure our customizer sections start after WordPress default ones
					...
					$priority = absint( apply_filters( 'wmhook_modern_library_customize_priority', 200 ) );
