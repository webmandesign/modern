 ...
 * 100) Helpers
 */
class Modern_Library_CSS_Variables {
	 ...
	 */
		...
		public static $cache_key = 'modern_css_vars';
			...
			// Processing
				...
				// Hooks
					...
					// Actions
						...
						add_action( 'wmhook_modern_library_theme_upgrade', __CLASS__ . '::cache_flush' );
	 ...
	 */
		...
		public static function get_variables_array() {
			...
			// Processing
				...
				foreach ( $theme_options as $option ) {
					 ...
					 */
					$css_vars = apply_filters( 'wmhook_modern_library_css_variables_get_variables_array_per_option', $css_vars, $option, $value );
				}
			...
			// Output
				 ...
				 */
				return (array) apply_filters( 'wmhook_modern_library_css_variables_get_variables_array', $css_vars );
		...
		public static function get_variables_string( $separator = ' ' ) {
			...
			// Output
				 ...
				 */
				return (string) apply_filters( 'wmhook_modern_library_css_variables_get_variables_string', trim( (string) $css_vars ) );
...
} // /Modern_Library_CSS_Variables

add_action( 'after_setup_theme', 'Modern_Library_CSS_Variables::init', 20 );
